...
#[cfg(feature = "transport")]
pub use transport::{
    Cause, Deliverable, Notifier, Service, CONTROL_INFO_KIND, CONTROL_REQUEST_KIND,
    CONTROL_RESPONSE_KIND, NOTIFICATION_KIND, WALLET_INFO_KIND, WALLET_NOTIFICATION_KIND,
    WALLET_REQUEST_KIND, WALLET_RESPONSE_KIND,
};
